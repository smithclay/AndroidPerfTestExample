...
public class MainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NewRelic.withApplicationToken(BuildConfig.NEWRELIC_TOKEN).start(this.getApplication());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.fetch_action:
                ...
                return true;
            case R.id.fail_action:
                // Returns a 500
                new DownloadTask().execute("http://www.mocky.io/v2/571945a0250000671f856c84");
                return true;
